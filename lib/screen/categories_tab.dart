                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => FeatureImageScreen(
                                  query: categoriesItem[index],
                                  image: categoriesPhotos[index],
                                ),
                              ),
                            );
                            Provider.of<PhotoSearchProvider>(context,
                                    listen: false)
                          ...
                          child: Stack(
                            children: [
                              SizedBox(
                                  ...
                                  width: double.infinity,
                                  child: Image.asset(
                                    categoriesPhotos[index].toString(),
                                    fit: BoxFit.cover,
                                  )),
                              Container(
                                height: 200,
